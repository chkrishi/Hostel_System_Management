...
class PrevOutpass extends StatefulWidget {
  String email;
  PrevOutpass({super.key, required this.email});

  @override
  State<PrevOutpass> createState() => _PrevOutpassState();
}

class _PrevOutpassState extends State<PrevOutpass> {
  @override
